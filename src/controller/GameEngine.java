...
public class GameEngine {
	...
	public void startGame(int aInitStackValue, int aMinBetValue){
        ...
        while(startNewRound()){
            gameInterface.redraw(players, (Card[])opennedCards.toArray(), lastPlayerAction, bankValue);
        }
	}
	...
	private boolean nextAction(){
        ...
        if(actionPlayer.getClass() == User.class){
            ...
            Action botAction = ((Bot)actionPlayer).makeAction(lastPlayerAction, (Card[])opennedCards.toArray(), bankValue);
