...
public class GameInterface {
	...
	public Action requestActionFromUser(Action botAction){
        ...
        while(true) {
            System.out.print("You turn('c' - check, 'f' - fold, '=' - call, 'a' - all in ,'<value> - bet', '+<value>' - raise): ");
            ...
            if(tok.length > 0) {
                if(tok[0].equals("c")) {
                    ...
                    int getVal = Integer.parseInt(firstTok.substring(1,firstTok.length())) + botAction.value;
                    if (getVal % 100 != 0) {
                        System.out.println("Must be divisible by 100");
                        continue;
                    }
